...
public class UserController {
    ...
    // Rotta per la vista di registrazione
    @GetMapping("/register")
    ...
    public String registration(@Valid @ModelAttribute("user") UserDto userDto,
        ...
        redirectAttributes.addFlashAttribute("successMessage", "Registrazione avvenunta!");

        return "redirect:/";
    }

    // Rotta per la vista di login
    @GetMapping("/login")
    public String login() {
        return "auth/login";
    }

    // Rotta per la ricerca dell'articolo in base all'utente
